...
public class UserController {
    ...
    public ResponseEntity nuevoUsuario (@RequestBody User newUser){
        ArrayList<User> lista_users = GetListausers();
    ...
    public ResponseEntity editarUsuario (@RequestBody User userEditado){
        ArrayList<User> lista_users = GetListausers();
    ...
    public ResponseEntity borradoUser(int id){
        ArrayList<User> lista_users = GetListausers();
    ...
    private ArrayList<User> GetListausers(){
